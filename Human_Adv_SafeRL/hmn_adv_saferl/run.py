import hmn_adv_saferl
from hmn_adv_saferl.user_config import DEFAULT_BACKEND
from hmn_adv_saferl.utils.run_utils import ExperimentGrid
from hmn_adv_saferl.utils.serialization_utils import convert_json
import argparse
import gym
import json
...
if __name__ == '__main__':
    ...
    if cmd in valid_help:
        ...
        help_msg = dedent("""
            ...
            \tpython -m hmn_adv_saferl.run CMD [ARGS...]
        ...
        special_info = dedent("""
            ...
            \tpython -m hmn_adv_saferl.run ppo --env HalfCheetah-v2 --clip_ratio 0.1

            If you need a quick refresher on valid kwargs, get the docstring
            with

            \tpython -m hmn_adv_saferl.run [algo] --help
